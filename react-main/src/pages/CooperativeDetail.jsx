...
const CooperativeDetail = () => {
  ...
  const fetchCooperativeDetails = async () => {
    try {
      ...
      setError("Erreur lors du chargement de la coopérative");
  ...
  const getCooperativeImage = (coop) => {
    if (coop?.image) {
      // If image starts with 'uploads/', prepend the base URL
  ...
  const handleWhatsAppClick = () => {
    ...
    if (phone) {
      ...
      const message = encodeURIComponent(`Bonjour, je souhaite obtenir plus d'informations sur vos produits.`);
      ...
      <>
        ...
        <div className="min-h-screen flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-gray-600 text-lg">Chargement de la coopérative...</p>
          </div>
        </div>
        <Footer />
      </>
  ...
  if (error || !cooperative) {
    return (
      <>
        ...
        <div className="min-h-screen flex items-center justify-center">
          <div className="text-center">
            <p className="text-red-600 text-xl mb-4">{error || "Coopérative non trouvée"}</p>
            <button
      ...
      <div className="bg-gray-50 py-4">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="flex items-center gap-2 text-sm text-gray-600">
            ...
            <span>/</span>
            <Link to="/cooperatives" className="hover:text-green-600">Coopératives</Link>
            <span>/</span>
            ...
            <div className="space-y-4">
              ...
              {cooperative.contact && (
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-gray-700">Personne de contact</p>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            ...
            <div className="space-y-3">
              ...
              {!cooperative.facebook && !cooperative.instagram && !cooperative.whatsapp && (
                <p className="text-gray-500 text-center py-4">Aucun réseau social disponible</p>
              )}
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          {products.length === 0 ? (
            <div className="text-center py-16 bg-gray-50 rounded-xl">
              ...
              <p className="text-gray-600 text-xl">Aucun produit disponible pour cette coopérative</p>
            </div>
          ) : (
                  ...
                  <div className="p-6 flex-1 flex flex-col">
                    ...
                    <div className="flex items-center justify-between pt-4 border-t">
                      <div className="text-sm text-gray-500">
                        Stock: <span className="font-semibold text-gray-700">{product.quantity}</span>
                      </div>
